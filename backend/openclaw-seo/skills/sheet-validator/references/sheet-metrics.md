...
All 14 sheets are written to `companies/<slug>/memory/sheets/`:
...
Must explain: current trajectory of SEO performance, the macro context (industry trends, algorithm updates, competitive movements), why the 12-week direction was chosen, and what success looks like at Week 12. Written for a business owner, not a developer.
...
- Minimum 15 long-tail keywords (3+ words).
